...
/**
 * @brief A transpose for matrices of size 32x32 or 1024x1024
 * Uses blocking to minimize clock cycles
 */

static void transpose_32_1024(size_t M, size_t N, const double A[N][M],
                              double B[M][N], double tmp[TMPCOUNT]) {
